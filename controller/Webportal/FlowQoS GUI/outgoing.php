...
<div id="name">
  ...
  <div id="basic-container" >
    <div id="test-header" class="container_headings header_highlight"><a href="index.php">Incoming Internet Traffic</a> | Outgoing Internet Traffic | <a href="Device.php"> Devices </a> |<a href="spam.php"> Spam Filter </a> </div>
    <div id="test-content">
