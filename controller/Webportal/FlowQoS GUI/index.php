...
<div id="name">
  ...
  <div id="basic-container" >
    <div id="test-header" class="container_headings header_highlight"> Incoming Internet Traffic | <a href="outgoing.php"> Outgoing Internet Traffic </a> | <a href="device.php"> Devices </a> |<a href="spam.php"> Spam Filter </a> </div>
    <div id="test-content">
